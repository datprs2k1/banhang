                                ...
                                <div class="tab-content p-0">
                                    ...
                                    <div class="chart tab-pane active" id="revenue-chart"
                                        ...
                                        <canvas id="revenue-chart-canvas" height="375"
                                            style="height: 300px; display: block; width: 894px;" width="1117"
                        ...
                        <div class="card bg-gradient-primary">
                            ...
                            <div class="card-body">
                                <div id="world-map"
                                    ...
                                    <svg width="893.8" height="250">
                                        <g transform="scale(0.42158516020236086) translate(580.5468, 0)">
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                original="#f4f3f0" id="jqvmap1_ak" class="jqvmap-region" fill-opacity="1">
                                            </path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                original="#f4f3f0" id="jqvmap1_mn" class="jqvmap-region" fill-opacity="1">
                                            </path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                original="#f4f3f0" id="jqvmap1_co" class="jqvmap-region" fill-opacity="1">
                                            </path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                original="#f4f3f0" id="jqvmap1_az" class="jqvmap-region" fill-opacity="1">
                                            </path>
                                            <path
                        ...
                        <div class="card bg-gradient-info">
                            ...
                            <div class="card-body">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="line-chart"
                                    style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 894px;"
                                    width="1117" height="312"></canvas>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-4 text-center">
                                        <div style="display:inline;width:60px;height:60px;"><canvas width="75" height="75"
                                                style="width: 60px; height: 60px;"></canvas><input type="text"
                                                class="knob" data-readonly="true" value="20" data-width="60"
                                    ...
                                    <div class="col-4 text-center">
                                        <div style="display:inline;width:60px;height:60px;"><canvas width="75" height="75"
                                                style="width: 60px; height: 60px;"></canvas><input type="text"
                                                class="knob" data-readonly="true" value="50" data-width="60"
                                                data-height="60" data-fgcolor="#39CCCC" readonly="readonly"
                                                style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; background: none; font: bold 12px Arial; text-align: center; color: rgb(57, 204, 204); padding: 0px; appearance: none;">
                                        </div>
                                        <div class="text-white">Online</div>
                                    ...
                                    <div class="col-4 text-center">
                                        <div style="display:inline;width:60px;height:60px;"><canvas width="75" height="75"
                                                style="width: 60px; height: 60px;"></canvas><input type="text"
                                                class="knob" data-readonly="true" value="30" data-width="60"
                                                data-height="60" data-fgcolor="#39CCCC" readonly="readonly"
                                                style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; background: none; font: bold 12px Arial; text-align: center; color: rgb(57, 204, 204); padding: 0px; appearance: none;">
                                        </div>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="picker-switch" data-action="pickerSwitch"
                                                                        colspan="5" title="Select Month">April 2022</th>
